...
class RemoveHttpHeadersMiddleware implements HttpKernelInterface {
   ...
   *   The config manager service.
   */
  public function __construct(HttpKernelInterface $httpKernel, CacheBackendInterface $cache, ConfigManager $configManager) {
   ...
   */
  protected function removeConfiguredHttpHeaders(Response $response) {
