 ...
 * @Block(
 * id = "block_filterckan_counter",
 * admin_label = @Translation("Filter block counter"),
 * )
 */
class FilterCkanCounter extends BlockBase {
  ...
  public function build() {
      ...
      $html .= '        <p class="font-22">Dataset Trovati:&nbsp;&nbsp;<span class="font-weight-bold" id="countDataset">795</span></p>';
      $html .= '    </div>';
      $html .= '</div>';
